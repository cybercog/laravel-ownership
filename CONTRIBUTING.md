...
We are trying to keep backwards compatibility breaks in Laravel Ownership to an absolute minimum. Please take this into account when proposing changes.
...
- [General problems](https://github.com/cybercog/laravel-ownership/issues)
